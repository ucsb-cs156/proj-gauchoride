...
describe("AdminUsersPage tests", () => {
    ...
    test("usertable toggle driver tests", async ()=>{
        ...
        const toggleDriverButton = screen.getByTestId(`${testId}-cell-row-2-col-Toggle Driver-button`);
    ...
    test("usertable toggle rider tests", async ()=>{
        ...
        const toggleRiderButton = screen.getByTestId(`${testId}-cell-row-2-col-Toggle Rider-button`);
